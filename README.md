...
Этот проект представляет собой Telegram бота для продажи и управления GUARD подписками через панель управления 3X-UI. Бот позволяет пользователям приобретать подписки на GUARD, создавать и управлять своими профилями, а администраторам — управлять пользователями и отслеживать статистику.

Основные возможности:

- Регистрация пользователей и предоставление пробного периода
- Продление подписки через платежную систему Telegram
- Создание и удаление GUARD профилей (VLESS) в панели 3X-UI
...
1. **`users`** - информация о пользователях:
   ...
   - `vless_profile_data` - данные GUARD профиля в JSON
   - `is_admin` - флаг администратора
1. **`static_profiles`** - статические GUARD профили:
