    ...
    <body style="font-family: 'Helvetica Neue', Arial, sans-serif; background-color: #0f172a; color: #f8fafc; margin: 0; padding: 10px;">
        <div style="max-width: 650px; margin: 0 auto; padding-top: 10px;">
            ...
            <div style="background-color: #1e293b; border-left: 4px solid #3b82f6; border-radius: 16px; padding: 20px; margin-bottom: 24px;">
                ...
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 1.</b> Скачайте приложение из App Store:</p>
                ...
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 2.</b> Скопируйте ссылку-автонастройку (синий блок сверху).</p>
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 3.</b> Откройте приложение, нажмите <b>"+"</b> и выберите <b>"Импорт из буфера обмена"</b>.</p>
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 0;"><b>Шаг 4.</b> Подключитесь, нажав огромную кнопку в центре экрана.</p>
            </div>
            ...
            <div style="background-color: #1e293b; border-left: 4px solid #10b981; border-radius: 16px; padding: 20px; margin-bottom: 24px;">
                ...
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 1.</b> Скачайте приложение из Google Play:</p>
                <div style="margin-bottom: 16px;">
                ...
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 2.</b> Скопируйте ссылку-автонастройку (в самом верху).</p>
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 3.</b> В приложении выберите <b>"Новый профиль"</b> -> <b>"Импорт из буфера обмена"</b>.</p>
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 0;"><b>Шаг 4.</b> Нажмите большую кнопку для подключения.</p>
            </div>
            ...
            <div style="background-color: #1e293b; border-left: 4px solid #a855f7; border-radius: 16px; padding: 20px; margin-bottom: 24px;">
                ...
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 2.</b> Установите и запустите программу.</p>
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 0;"><b>Шаг 3.</b> Скопируйте ссылку сверху и добавьте её в разделе <b>"Подписки"</b> (или "Новый профиль").</p>
            </div>
            ...
            <div style="background-color: #1e293b; border-left: 4px solid #ec4899; border-radius: 16px; padding: 20px; margin-bottom: 24px;">
                ...
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 1.</b> Скачайте образ программы:</p>
                <div style="margin-bottom: 16px;">
                ...
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 8px;"><b>Шаг 2.</b> Перетяните иконку в папку Программы (Applications).</p>
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 0;"><b>Шаг 3.</b> Запустите, скопируйте вашу ссылку-подписку и добавьте её в приложение.</p>
            </div>
            ...
            <div style="background-color: #1e293b; border-left: 4px solid #f97316; border-radius: 16px; padding: 20px; margin-bottom: 24px;">
                ...
                <p style="color: #cbd5e1; font-size: 14px; margin-top: 0; margin-bottom: 8px;"><b>Для TV:</b> Найдите в Google Play <b>Hiddify</b> или <b>v2rayTun</b>. В меню выберите "Новая подписка" и вставьте вашу ссылку.</p>
